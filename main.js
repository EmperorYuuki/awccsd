...
document.addEventListener('DOMContentLoaded', async function() {
  try {
    ...
    // Step 4: Initialize anime guide
    console.log('Initializing anime guide...');
    if (serviceExists('AnimeGuideService')) {
      window.AnimeGuideService.initialize();
      window.AnimeGuideService.setupTabListeners();
    } else {
      console.warn('AnimeGuideService not found, skipping anime guide initialization');
    }
